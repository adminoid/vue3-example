...
.left-sidebar(:class="{open: sidebarOpen}")
  ...
  .left-sidebar__sticker(v-if="sidebarOpen")
    svg(v-if="true" width='17px' height='17px' xmlns='http://www.w3.org/2000/svg')
    ...
    svg(v-else width='14px' height='14px' xmlns='http://www.w3.org/2000/svg')
      g#pinner(transform='translate(-303.000000, -176.000000)' fill='#A9A9A9')
        path#Combined-Shape(d='M309,177 C310.198856,177 311.399393,177.284633 312.601611,177.8539 C313.135031,'
